    ...
    D: DelayMs<u8>,
{
    ...
    pub fn temperature(&mut self) -> Result<MilliCelsius, Error<E>> {
    ...
    /// returning the measured value.
    pub fn rel_humidity(&mut self) -> Result<RHPerCentMille, Error<E>> {
...
fn convert_raw_temperature(temp_raw: u16) -> MilliCelsius {
    MilliCelsius((((((temp_raw & 0xfffc) as u32) * 21965) >> 13) - 46850) as i32)
}
...
fn convert_raw_rh(humidity_raw: u16) -> RHPerCentMille {
    RHPerCentMille((((((humidity_raw & 0xfffc) as u32) * 15625) >> 13) - 6000) as i32)
}
